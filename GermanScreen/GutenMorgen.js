    ...
    <SafeAreaView style={styles.MainContainer}>
        <View style={styles.Content}>
            <View style={styles.HeaderContainer}>
                <Text style={styles.headertitle}>German</Text>
            </View>

                <View style={styles.BodyContainer}>

                    {/*Japanese*/}
                    <Text style={styles.LanguageTitle}>German</Text>

                    <View style={styles.Card}>
                    <Text style={styles.CardText}>Guten Morgen</Text>
                    </View>
                ...
                <View style={styles.Buttonview}>
                    ...
                    <TouchableOpacity style={styles.Button} onPress={() => navigation.navigate('Hallo')}>
